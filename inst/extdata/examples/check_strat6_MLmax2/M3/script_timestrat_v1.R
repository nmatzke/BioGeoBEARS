...
wd = "/GitHub/BioGeoBEARS/inst/extdata/examples/check_strat6_MLmax2/M3/"
setwd(wd)
...
runslow = TRUE
resfn = "3taxa_DEC_M3_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "3taxa_DEC+J_M3_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "3taxa_DEC_vs_DEC+J_M3_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on 3taxa M3_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on 3taxa M3_unconstrained"
