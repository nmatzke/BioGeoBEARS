...
# rerun_optim_table_DECx = rerun_optimization_w_HiLow(res=NULL, Rdata_fn=Rdata_fn, runslow=FALSE)
# 
# Rdata_fn = "DECJx+t12+t21+m2_inf_v3b.Rdata"
# rerun_optim_table_DECjx = rerun_optimization_w_HiLow(res=NULL, Rdata_fn=Rdata_fn, runslow=FALSE)
# 
