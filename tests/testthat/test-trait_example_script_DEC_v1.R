...
DEC_t12_t21_m2_lnL = -123.7404
DEC_t12_t21_m2_d = 1.225874e-02
DEC_t12_t21_m2_e = 1.000000e-12
DEC_t12_t21_m2_j = 0.000000e+00
DEC_t12_t21_m2_t12 = 1.244768e-02
DEC_t12_t21_m2_t21 = 1.092238e-02
DEC_t12_t21_m2_m2 = 5.478515e-01

DECj_t12_t21_m2_rep1_lnL = -115.1835
DECj_t12_t21_m2_rep1_d = 1.010895e-02
DECj_t12_t21_m2_rep1_e = 1.000000e-13
DECj_t12_t21_m2_rep1_j = 2.080750e-01
DECj_t12_t21_m2_rep1_t12 = 1.272027e-02
DECj_t12_t21_m2_rep1_t21 = 1.078116e-02
DECj_t12_t21_m2_rep1_m2 = 3.126001e-01

DECj_t12_t21_m2_rep2_lnL = -115.1835
DECj_t12_t21_m2_rep2_d = 1.010743e-02
DECj_t12_t21_m2_rep2_e = 1.000000e-13
DECj_t12_t21_m2_rep2_j = 2.084038e-01
DECj_t12_t21_m2_rep2_t12 = 1.272619e-02
DECj_t12_t21_m2_rep2_t21 = 1.079082e-02
DECj_t12_t21_m2_rep2_m2 = 3.126754e-01
...
txt = "Checking that DEC+J+t12+t21+m2 lnL (on rep. 1) >= DEC+t12+t21+m2 lnL (which it must be, as DEC+t12+t21+m2 is nested inside DEC+J+t12+t21+m2) (archive values)..."
cat("\n")
cat(txt)
expect_gt(object=DECj_t12_t21_m2_rep1_lnL, expected=DEC_t12_t21_m2_lnL)
cat("...PASSED  ")


txt = "Checking that DEC+J+t12+t21+m2 lnL (on rep. 1) >= DEC+t12+t21+m2 lnL (which it must be, as DEC+t12+t21+m2 is nested inside DEC+J+t12+t21+m2) (test values)..."
cat("\n")
cat(txt)
expect_gt(object=DECj_t12_t21_m2_results[1], expected=DEC_t12_t21_m2_results[1])
cat("...PASSED  ")
...
txt = "Checking that DEC+J+t12+t21+m2 lnL (on rep. 2) >= DEC+t12+t21+m2 lnL (which it must be, as DEC+t12+t21+m2 is nested inside DEC+J+t12+t21+m2) (archive values)..."
cat("\n")
cat(txt)
expect_gt(object=DECj_t12_t21_m2_rep2_lnL, expected=DEC_t12_t21_m2_lnL)
cat("...PASSED  ")


txt = "Checking that DEC+J+t12+t21+m2 lnL (on rep. 2) >= DEC+t12+t21+m2 lnL (which it must be, as DEC+t12+t21+m2 is nested inside DEC+J+t12+t21+m2) (test values)..."
cat("\n")
cat(txt)
expect_gt(object=DECj_t12_t21_m2_rep2_results[1], expected=DEC_t12_t21_m2_results[1])
cat("...PASSED  ")
