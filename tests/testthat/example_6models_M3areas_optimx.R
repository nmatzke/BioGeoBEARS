...
BioGeoBEARS_run_object$timesfn = np(slashslash(paste0(extdata_dir, "/examples/Psychotria_M3strat/BGB/", "timeperiods.txt")))
BioGeoBEARS_run_object$dispersal_multipliers_fn = np(slashslash(paste0(extdata_dir, "/examples/Psychotria_M3strat/BGB/", "dispersal_multipliers.txt")))
BioGeoBEARS_run_object$areas_allowed_fn = np(slashslash(paste0(extdata_dir, "/examples/Psychotria_M3strat/BGB/", "areas_allowed.txt")))
